...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1470820972);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1470820852);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1470820732);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1470821092);
...
user_pref("datareporting.sessions.current.firstPaint", 2789);
user_pref("datareporting.sessions.current.main", 335);
user_pref("datareporting.sessions.current.startTime", "1470820610570");
...
user_pref("extensions.blocklist.pingCountTotal", 142);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1470820973);
...
user_pref("idle.lastDailyNotification", 1470824929);
...
user_pref("mail.displayname.version", 63);
