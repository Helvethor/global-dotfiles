...
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1475849639);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1475849519);
...
user_pref("datareporting.sessions.current.firstPaint", 7008);
user_pref("datareporting.sessions.current.main", 364);
user_pref("datareporting.sessions.current.startTime", "1476004706484");
user_pref("datareporting.sessions.current.totalTime", 128);
user_pref("datareporting.sessions.currentIndex", 57);
user_pref("datareporting.sessions.previous.53", "{\"s\":1475490842529,\"a\":0,\"t\":6,\"c\":false,\"m\":258,\"fp\":3163,\"sr\":-1}");
...
user_pref("datareporting.sessions.prunedIndex", 52);
user_pref("extensions.blocklist.pingCountTotal", 174);
...
user_pref("idle.lastDailyNotification", 1476005728);
