...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1468585316);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1468585196);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1468585436);
...
user_pref("extensions.blocklist.pingCountTotal", 133);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1468585317);
...
user_pref("idle.lastDailyNotification", 1468563558);
...
user_pref("mail.displayname.version", 60);
...
user_pref("places.database.lastMaintenance", 1468563559);
user_pref("places.history.expiration.transient_current_max_pages", 102660);
...
user_pref("storage.vacuum.last.places.sqlite", 1468563558);
