...
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1466935752);
...
user_pref("datareporting.sessions.current.firstPaint", 3102);
user_pref("datareporting.sessions.current.main", 245);
user_pref("datareporting.sessions.current.startTime", "1466935630924");
user_pref("datareporting.sessions.current.totalTime", 4045);
...
user_pref("idle.lastDailyNotification", 1466954298);
...
user_pref("mail.displayname.version", 57);
...
user_pref("places.database.lastMaintenance", 1465824219);
