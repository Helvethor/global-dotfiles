...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1467453637);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1467453397);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1467453517);
...
user_pref("datareporting.sessions.current.firstPaint", 2741);
user_pref("datareporting.sessions.current.main", 355);
user_pref("datareporting.sessions.current.startTime", "1467453276002");
user_pref("datareporting.sessions.current.totalTime", 228);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1467453638);
...
user_pref("idle.lastDailyNotification", 1467453676);
