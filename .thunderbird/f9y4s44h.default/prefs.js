...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1464106599);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1464106719);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1464106479);
...
user_pref("extensions.blocklist.pingCountVersion", 49);
...
user_pref("extensions.getAddons.cache.lastUpdate", 1464106600);
...
user_pref("idle.lastDailyNotification", 1464108552);
...
user_pref("mail.displayname.version", 49);
...
user_pref("places.database.lastMaintenance", 1463500868);
